...
if(isset($_GET["Recherche"])){		//Check si Recherche est différent de null
...
if(isset($_GET["verifier"])){
	...
	if (strpbrk($_SESSION["rechercher"],$_GET["verifier"])){		//strpbrk cherche un char dans une chaine de char
